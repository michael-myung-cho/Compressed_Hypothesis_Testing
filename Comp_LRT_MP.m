%% Comparison between Likelihood Ratio Test (LRT) and Message Passing (MP) method
%
...
filename = strcat('(',num2str(ni),'x',num2str(N),')','HT-Comp_LRT_MP',datestmp,'_mean_0_8_trial1000.xlsx');
